    ...
    */
    async save (obj) {
        try {
            ...
            throw new Error(`Ha ocurrido un error al guardar ${error}`)       
        }
    }
    ...
    */
    ...
    async updateById (id, obj) {
        try {
            ...
            objetos[indexObj] = {...objetos[indexObj], ...obj}
            console.log(objetos[indexObj])
...
//     console.log(await p.getAll())
//     p.save({'test': 'test'})
//     p.updateById(1, {test: "esto es el test actualizado"})
// }
// main()
